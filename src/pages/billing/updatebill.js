                  ...
                  <div className="col-span-3">
                    ...
                    <div className="mt-2">
                      <Select
                        ...
                        value={{
                          value:
                            billData[0]?.property.buildingName ||
                            "defaultValue",
                          label:
                            billData[0]?.property.buildingName ||
                            "Default Label",
                  ...
                  <div className="col-span-3">
                    ...
                    <div className="mt-2">
                      <Select
                        ...
                        value={{
                          value:
                            billData[0]?.customers.fullName || "defaultValue",
                          label:
                            billData[0]?.customers.fullName || "Default Label",
                        }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="w-50">
                    ...
                    <div className="mt-2">
                      <Select
                        ...
                        classNamePrefix="select"
                        value={{
                          value: billData[0]?.businessType.businessTypeName,
                          label: billData[0]?.businessType.businessTypeName,
                        }}
                        isDisabled={true}
                      />
                    </div>
                  ...
                  <div className="w-50 ">
                    ...
                    <div className="mt-2">
                      <Select
                        ...
                        value={{
                          value:
                            billData[0].agencies.agencyName || "defaultValue",
                          label:
                            billData[0].agencies.agencyName || "Default Label",
                        }}
                      />
                    </div>
                  </div>
