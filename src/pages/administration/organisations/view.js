...
//     // if (!selectedItem || !selectedItem.organisationId) {
//     //   console.error("selectedItem is not defined or does not have an organisationId property");
//     //   return;
//     // }
//     setTimeout(()=>{
...
// // const handleCheckboxChange = (event, moduleId, moduleName) => {
// //   const { checked } = event.target;
// //   const isModuleSelected = selectedModules.some((item) => item.moduleId === moduleId);

// //   if (checked && !isModuleSelected) {
// //     setSelectedModules((prevSelectedModules) => [...prevSelectedModules, { moduleId, moduleName }]);
// //   } else if (!checked && isModuleSelected) {
// //     setSelectedModules(selectedModules.filter((item) => item.moduleId !== moduleId));
// //   }
// // };
// const handleCheckboxChange = (event, moduleId, item, moduleName) => {
//   const { checked } = event.target;
//   const isModuleSelected = selectedModules.includes(moduleId);
//   const isChecked = organisationModule.some(
//     (module) => module.modules && module.modules.moduleName === item.moduleName
//   );

//   if (checked && !isModuleSelected && !isChecked) {
...
//       { moduleId, modules: { moduleName: item.moduleName } },
//     ]);
//   } else if (!checked && (isModuleSelected || isChecked)) {
//     setSelectedModules(selectedModules.filter((item) => item !== moduleId));
//     setOrganisationModule(
//       organisationModule.filter(
//         (module) =>
//           (module.modules && module.modules.moduleName !== item.moduleName) ||
//           !module.modules
//       )
//     );
//   }
...
// // New handleCheckboxChange
// // const handleCheckboxChange = (event, moduleId) => {
// //   const isChecked = event.target.checked;

// //   if (isChecked) {
// //       const existingModule = organisationModule.find(module => module.moduleId === moduleId);
// //       if (!existingModule) {
// //           setOrganisationModule([...organisationModule, { moduleId, moduleName: event.target.name }]);
// //       }
// //   } else {
// //       setOrganisationModule(organisationModule.filter(module => module.moduleId !== moduleId));
// //   }
// // };
// ///// End  of the  newHandleCheckBoxChange
...
//                                                         {/* {moduleData.map((item, idx) => {
//                                                             const isModuleSelected = selectedModules.includes(item.moduleId);
//                                                             const isChecked = organisationModule.some(module => module.modules.moduleName === item.moduleName);
//                                                             return (
//                                                                 <tr key={item.moduleId}>
//                                                                     <td className="font-medium">
//                                                                         <input
...
//                                                                         <input
//                                                                           type="checkbox"
//                                                                           checked={organisationModule.some(module => module.moduleId === item.moduleId)}
...
//                                                         {/* {moduleData.map((item, idx) => {
//     const isModuleSelected = selectedModules.includes(item.moduleId);
//     const isChecked = organisationModule.some(module => module.modules && module.modules.moduleName === item.moduleName);
//     return (
//         <tr key={item.moduleId}>
//             <td className="font-medium">
//                 <input
...
// {moduleData.map((item, idx) => {
//     const isModuleSelected = selectedModules.includes(item.moduleId);
// const isChecked = organisationModule && organisationModule.some(module => module && module.modules && module.modules.moduleName === item.moduleName);
//     return (
//         <tr key={item.moduleId}>
//             <td className="font-medium">
//                 {/* <input
//                     type="checkbox"
//                     checked={isChecked || isModuleSelected}
//                     onChange={(event) => handleCheckboxChange(event, item.moduleId, item.moduleName)}
//                 />   */}
//                 {/* <input
//   type="checkbox"
//   checked={isChecked || isModuleSelected}
...
//   type="checkbox"
//   checked={isChecked || isModuleSelected}
//   value={isChecked || isModuleSelected}
//   onChange={(event) => handleCheckboxChange(event, item.moduleId)}
// /> */}
// <input
//   type="checkbox"
...
//             {/* <div className="modal fade" id="addModule" ref={addModuleModalRef}>
//         <div className="modal-dialog modal-xl">
//           <div className="modal-content">
//             <div className="modal-header">
//               <h4 className="modal-title">Add Module To Organisation</h4>
